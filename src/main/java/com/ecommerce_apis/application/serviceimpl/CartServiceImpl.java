...
public class CartServiceImpl implements CartService {
    ...
    public Cart createCart(User user) {
        try {
            ...
            logger.error("Failed to create cart for user: {}" + user.getUser_id());
            throw e;
        }
    }
    ...
    public void addCartItem(String userId, CartItemRequest request) {
        try {
            ...
            if (isExist == null) {
                ...
                logger.info("Added cart item {} to cart for user: {}" + createItem.getId());
            }
        } catch (Exception e) {
            logger.error("Failed to add cart item for user {}: {}" + e.getMessage());
            throw e;
        }
    }
    ...
    public Cart findUserCart(String userId) {
        try {
            ...
            logger.error("Failed to find cart for user {}: {}" + e.getMessage());
            throw e;
        }
    }
}
